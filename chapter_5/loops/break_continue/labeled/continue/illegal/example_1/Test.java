...
public class Test {
    public static void main(String[] args) {
        ...
        */
        ...
        /*
            Não compila: Test.java:27: error: not a statement
            o nome do labeled não eh um identificador valido no java
            identificadores validos podem começar com letras, $, _ seguido por letras, numeros, $, _
        */
        1outer:
        for(int i = 0; i < 5; i++) {
            for(int j = 0; j < 5; j++) {
